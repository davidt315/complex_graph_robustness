...
**Figure 2:** Replication of average path length graph shown in Figure 1. Nodes are removed randomly and targeted with an ER and HK graph both with 10,000 nodes and 20,000 edges. The HK probability of triangulation is 0.5. In our replication, we also included a random edge attack.
